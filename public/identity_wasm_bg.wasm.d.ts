...
export const __wbg_iotaidentityclientext_free: (a: number, b: number) => void;
export const iotaidentityclientext_newDidOutput: (a: any, b: any, c: number, d: number) => [number, number, number];
export const iotaidentityclientext_updateDidOutput: (a: any, b: number) => [number, number, number];
export const iotaidentityclientext_deactivateDidOutput: (a: any, b: number) => [number, number, number];
export const iotaidentityclientext_resolveDid: (a: any, b: number) => [number, number, number];
export const iotaidentityclientext_resolveDidOutput: (a: any, b: number) => [number, number, number];
...
export const iotadocument_unpackFromOutput: (a: number, b: any, c: number) => [number, number, number];
export const iotadocument_unpackFromBlock: (a: number, b: number, c: any) => [number, number, number];
...
export const iotadocument_metadataStateControllerAddress: (a: number) => [number, number, number, number];
export const iotadocument_metadataGovernorAddress: (a: number) => [number, number, number, number];
...
export const iotadocumentmetadata_stateControllerAddress: (a: number) => [number, number];
export const iotadocumentmetadata_governorAddress: (a: number) => [number, number];
...
export const closure757_externref_shim: (a: number, b: number, c: any) => void;
export const closure3245_externref_shim: (a: number, b: number, c: any, d: any) => void;
